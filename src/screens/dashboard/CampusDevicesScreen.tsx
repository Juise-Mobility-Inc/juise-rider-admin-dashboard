                                                                                ...
                                                                                {filteredEntries.map((entry) => {
                                                                                        ...
                                                                                        return (
                                                                                                <tr
                                                                                                        ...
                                                                                                        <td>
                                                                                                                <strong>{capitalize(entry.device.device_type) || "-"}</strong>
                                                                                                        ...
                                                                                                        <td>
                                                                                                                <strong>
                                                                                                                        {activeV > 0 ? (
                                                                                                                                <span className="cd-table-active-v">{activeV} active</span>
                                                                                                                        ) : (
                                                                                                                                `${totalV} total`
                                                                                                                        )}
                                                                                                                </strong>
                                                                                                        ...
                                                                                                        <td>
                                                                                                                <strong>{formatTimestamp(entry.device.created_at)}</strong>
