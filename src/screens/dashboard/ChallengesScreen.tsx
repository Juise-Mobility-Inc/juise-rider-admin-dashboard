						...
						<div className="challenge-table-section">
							{challengeListBusy ? (
								...
								<table className="challenge-table">
									<thead>
										<tr>
											<th className="challenge-table-th">
												...
												{currentAndUpcomingChallenges.map((ch) => {
													...
													return (
														<tr
															...
															<td className="challenge-table-td">
																<div className="challenge-table-title-cell">
																	<div className="challenge-table-thumb">
																		{ch.image_url.trim() ? (
																			<img src={ch.image_url} alt={ch.title} />
																		) : (
																			<span>{isGamesMode ? "SH" : "CH"}</span>
																		)}
																	</div>
																	<div>
																		<div className="challenge-table-title">
																			{ch.title}
																		</div>
																		<div className="challenge-table-type muted-text">
															...
															<td className="challenge-table-td challenge-table-muted">
																{formatDateTimeForDisplay(ch.start_time)} →{" "}
