...
function PoiRankings({ rankings }: { rankings: PoiRankingEntry[] }) {
        ...
        const visible = expanded
                ? rankings
                : rankings.slice(0, POI_RANKINGS_COLLAPSED_LIMIT);
...
function DashboardKpi({
        ...
        const card = (
                <article
                        className={`dashboard-kpi${to ? " dashboard-kpi--clickable" : ""}`}>
                        <span>{label}</span>
                        <strong>{value}</strong>
                        <small>{detail}</small>
                        {to ? (
                                <span className="dashboard-kpi-arrow" aria-hidden>
                                        →
                                </span>
                        ) : null}
                </article>
                                        ...
                                        {visuals.recentRidePenalties.length === 0 ? (
                                                ...
                                                <>
                                                        {(penaltiesExpanded
                                                                ...
                                                                : visuals.recentRidePenalties.slice(
                                                                                0,
                                                                                RIDE_PENALTIES_COLLAPSED_LIMIT,
                                                                        )
                                                        ).map((penalty) => (
                                                                <div
                                                        ...
                                                        {visuals.recentRidePenalties.length >
                                                                RIDE_PENALTIES_COLLAPSED_LIMIT && (
                                                                <button
                                                                        className="dashboard-poi-ranking-toggle"
...
export function DashboardScreen({
        ...
        const [devicePendingCount, setDevicePendingCount] = useState<number | null>(
                null,
        );
                        ...
                        {visuals ? (
                                <>
                                        <div className="dashboard-summary-row">
                                                <Link
                                                        className="dashboard-summary-stat dashboard-summary-stat-link"
                                                        to="/students">
                                                        <span className="dashboard-summary-label">
                                                                Registered students
                                                        </span>
                                                        <strong className="dashboard-summary-value">
                                                                {visuals.rosterCount.toLocaleString()}
                                                        </strong>
                                                        <small className="dashboard-summary-detail">
                                                ...
                                                <Link
                                                        ...
                                                        <strong className="dashboard-summary-value">
                                                                {deviceTotalCount !== null
                                                                        ? deviceTotalCount.toLocaleString()
                                                                        : "—"}
                                                        </strong>
                                                        <small className="dashboard-summary-detail">
                                                                View campus devices →
                                                ...
                                                <div className="dashboard-summary-divider" />
                                                <Link
                                                        className="dashboard-summary-stat dashboard-summary-stat-pending dashboard-summary-stat-link"
                                                        to="/vehicle-registrations">
                                                        <span className="dashboard-summary-label">Pending review</span>
                                                        <strong className="dashboard-summary-value">
                                                                {devicePendingCount !== null
                                                                        ? devicePendingCount.toLocaleString()
                                                                        : "—"}
                                                        </strong>
                                                        <small className="dashboard-summary-detail">
