...
function isBackgroundPenaltySession(
        session: StudentRouteHistorySession,
): boolean {
        return session.tracking_source.trim().toLowerCase() === "auto";
}

function formatActivitySessionSource(
        session: StudentRouteHistorySession,
): string {
        if (isBackgroundPenaltySession(session)) {
                return "Background monitor";
        }

        if (session.tracking_source.trim().toLowerCase() === "manual") {
                return "Tracked ride";
        }

        return session.tracking_source.trim() || "Tracked ride";
}
                                                                                        ...
                                                                                        {detailTab === "activity" && (
                                                                                                <div className="student-activity-subtabs">
                                                                                                        ...
                                                                                                        {/* {penaltyEvents.length > 0 && (
                                                                                                                <span
                                                                                                                        className="student-badge student-badge-muted"
                                                                                                                        title="Background monitor penalties are captured even when the student did not press Start Ride."
                                                                                                                >
                                                                                                                        {trackedRidePenaltyEvents.toLocaleString()} tracked ·{" "}
                                                                                                                        {backgroundPenaltyEvents.length.toLocaleString()} background
                                                                                                                </span>
                                                                                                        )} */}
                                                                                                </div>
                                                                                        )}
                                                                                                                                ...
                                                                                                                                <table className="act-table">
                                                                                                                                        ...
                                                                                                                                        {visitedPoiVisits.map(
                                                                                                                                                ({ poi, session }, index) => {
                                                                                                                                                        ...
                                                                                                                                                        const isOpen =
                                                                                                                                                                expandedActivityKey === rowKey;
                                                                                                                                                        const hasRide = session.points.length > 0;
                                                                                                                                                        ...
                                                                                                                                                        return (
                                                                                                                                                                <tbody key={rowKey}>
                                                                                                                                                                        <tr
                                                                                                                                                                                ...
                                                                                                                                                                                <td>{session.trip_mode || "—"}</td>
                                                                                                                                                                                <td>
                                                                                                                                                                                        {hasRide && poiStudentUUID ? (
                                                                                                                                                                                                <button
                                                                                                                                                                                                        className="act-visit-ride-btn"
                                                                                                                                                                                                        type="button"
                                                                                                                                                                                                        onClick={(e) => {
                                                                                                                                                                                                                e.stopPropagation();
                                                                                                                                                                                                                const params =
                                                                                                                                        ...
                                                                                                                                        onClick={() => {
                                                                                                                                                ...
                                                                                                                                                const csvRows: CsvCell[][] = events.map(
                                                                                                                                                        ({ event, session }) => [
                                                                                                                                                                ...
                                                                                                                                                                formatActivitySessionSource(session),
                                                                                                                                ...
                                                                                                                                <table className="act-table">
                                                                                                                                        ...
                                                                                                                                        {(activitySubTab === "speed"
                                                                                                                                                ...
                                                                                                                                                const isBackgroundOnly =
                                                                                                                                                        isBackgroundPenaltySession(session);
                                                                                                                                                                                                ...
                                                                                                                                                                                                <div className="student-event-card">
                                                                                                                                                                                                        <div className="student-event-copy">
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                <span>
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        {isBackgroundOnly
                                                                                                                                                                                                                                ? " · captured while the student was not in a manually tracked ride"
                                                                                                                                                                                                                                : ""}
                                                                                                                                                                                                                </span>
