                                        ...
                                        <div className="notification-audience-desc">
                                                {audience === "school" ? (
                                                        <>
                                                                ...
                                                                <span><strong>Campus Wide</strong> — these notifications will be delivered to all students enrolled at this school.</span>
                                                        </>
                                                ) : (
                                                        <>
                                                                <span className="notification-audience-desc-icon">🎯</span>
                                                                <span><strong>Students</strong> — these notifications will only be delivered to the specific students you select below.</span>
                                                        </>
                                                )}
                                        </div>
